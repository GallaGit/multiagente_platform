...
- M04: D08, D13, D20 y D29 ([Resumen](../../Modulo-04-Dolor-del-Cliente/Resumen-Ejecutivo.md)).
- M05: frontera competitiva = datos, permisos y handoff ([Competencia](../../Modulo-05-Competencia/Resumen-Ejecutivo.md#6-nivel-de-innovación)).
- M06: O19 es hipótesis; O10/O15 están respaldadas ([O19](../../Modulo-06-Oportunidades-de-Negocio/Oportunidades/19-Oportunidad.md)).
- M08: ICP-01 exige cambio de proceso, no “añadir IA” ([ICP-01](../../Modulo-08-Cliente-Ideal-ICP/ICP/ICP-01.md)).
