...
- M04: D19–D23 y D29 ([Resumen](../../Modulo-04-Dolor-del-Cliente/Resumen-Ejecutivo.md)).
- M05: las plataformas horizontales exigen mantenimiento y las microagencias carecen normalmente de roles dedicados ([Competencia](../../Modulo-05-Competencia/Analisis/Vacios-Competitivos.md)).
- M06: O15 y dependencias muy altas ([O15](../../Modulo-06-Oportunidades-de-Negocio/Oportunidades/15-Oportunidad.md)).
- M08: ICP-01 tiene base digital y un posible champion de operaciones/CRM ([ICP-01](../../Modulo-08-Cliente-Ideal-ICP/ICP/ICP-01.md)).
