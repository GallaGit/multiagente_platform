# Contexto del nicho inmobiliario
...
Ayudar a inmobiliarias a reducir tiempo, costes, errores y pérdida de trazabilidad. El cliente compra un resultado operativo, no horas de programación.

## Nicho

El mercado es **España**. El cliente prioritario es una agencia residencial independiente profesionalizada, con CRM activo, varios canales y autonomía para cambiar procesos (ICP-01).
...
La expansión no debe ocurrir antes de demostrar capacidad de venta, entrega y mantenimiento en este nicho.
...
- no un SaaS horizontal ni un bot de ventas como oferta inicial.
...
## Estrategia de este nicho

- consolidar conocimiento de agencias inmobiliarias;
- validar el Sprint de Orquestación de Leads;
- ejecutar una prueba técnica real (Witei / Smart Inbox) y discovery comercial;
- conseguir al menos un compromiso económico;
- SaaS vertical e internacionalización solo con repetición demostrada.
