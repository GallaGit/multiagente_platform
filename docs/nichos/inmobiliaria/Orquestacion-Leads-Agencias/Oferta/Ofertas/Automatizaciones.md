...
- M04: D19–D22 ([Resumen](../../Dolor-del-Cliente/Resumen-Ejecutivo.md)).
- M05: Make es potente, pero exige modelo y mantenimiento ([Competencia](../../Competencia/Resumen-Ejecutivo.md#plataformas-horizontales)).
- M06: O05, O09, O15 y O16 ([Ranking](../../Oportunidades-de-Negocio/Analisis/Ranking-General.md)).
- M08: ICP-01 con stack y señales observables ([ICP-01](../../Cliente-Ideal-ICP/ICP/ICP-01.md)).
