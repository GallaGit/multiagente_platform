...
- M04: D19–D22 y D29 ([Resumen](../../Dolor-del-Cliente/Resumen-Ejecutivo.md)).
- M05: interoperabilidad y calidad como espacio estratégico ([Competencia](../../Competencia/Resumen-Ejecutivo.md#3-interoperabilidad-y-calidad-del-dato-en-el-stack-español)).
- M06: O15, índice 96, complejidad muy alta ([O15](../../Oportunidades-de-Negocio/Oportunidades/15-Oportunidad.md)).
- M08: ICP-01 es candidato de validación, no compra demostrada ([Resumen ICP](../../Cliente-Ideal-ICP/Resumen-Ejecutivo.md)).
