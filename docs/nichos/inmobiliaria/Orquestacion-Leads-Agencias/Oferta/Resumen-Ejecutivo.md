...
El destinatario inicial es el [ICP-01](../Cliente-Ideal-ICP/ICP/ICP-01.md): agencia residencial independiente con 3–20 agentes, al menos cinco usuarios activos, CRM vertical, más de dos canales, WhatsApp o Excel fuera del registro, datos exportables y propietario-gerente accesible.
